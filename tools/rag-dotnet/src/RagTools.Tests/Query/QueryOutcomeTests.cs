...
public sealed class QueryOutcomeTests
{
    ...
    public void Success_HoldsResponse()
    {
        var response = new QueryResponse(
            ...
            Hits: new[]
            {
                new QueryHit(1, 0.92, "doc", "docs/concepts/hex.md", "concepts > hex", "Hexagonal architecture..."),
                new QueryHit(2, 0.81, "doc", "docs/concepts/ports.md", "concepts > ports", "Ports and adapters..."),
            },
            TotalCandidates: 12);
    ...
    {
        var hit = new QueryHit(3, 0.755, "adr", "docs/adr/0001.md", "adr > 0001", "decision...");
