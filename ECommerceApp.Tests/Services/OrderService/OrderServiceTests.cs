...
{
    public class OrderServiceTests// : BaseServiceTest<OrderDto, IOrderRepository, OrderRepository, Application.Services.OrderService, Order>
    {
      /*  [Fact]
        public void CanReturnOrder()
        {
            ...
            coupon.Should().BeOfType(typeof(OrderDto));
        }
        ...
        {
            var order = new OrderDto { Id = 1000 };
