...
namespace ECommerceApp.Shared.TestInfrastructure
{
    public class Utilities
    {
        public static void InitilizeDbForTests(Context context)
        {
            ...
            var currency3 = new Domain.Model.Currency { Id = 4, Code = "USD", Description = "Dolar amerykañski" };
            ...
            var payment3 = new Domain.Model.Payment { Id = 3, CurrencyId = 1, CustomerId = 1, DateOfOrderPayment = DateTime.Now, OrderId = 2, Number = "124523" };
            context.Add(payment3);

            var tag = new Domain.Model.Tag { Id = 1, Name = "Tag" };
            context.Add(tag);
            var tag3 = new Domain.Model.Tag { Id = 3, Name = "Tag3" };
            context.Add(tag3);
