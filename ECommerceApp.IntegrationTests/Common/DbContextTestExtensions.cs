...
namespace ECommerceApp.IntegrationTests.Common
{
    ...
    internal static class DbContextTestExtensions
    {
        ...
        /// </summary>
        internal static IServiceCollection ReplaceDbContextWithInMemory<TContext>(
        ...
        /// </summary>
        internal static IServiceCollection ReplaceDbContextWithInMemory(
            this IServiceCollection services,
            Type dbContextType,
            string dbName)
        {
        ...
        /// </summary>
        internal static IServiceCollection RemoveDbContextOptionsRegistrations<TContext>(
            this IServiceCollection services)
            where TContext : DbContext
            => services.RemoveDbContextOptionsRegistrations(typeof(TContext));

        /// <summary>Non-generic overload.</summary>
        internal static IServiceCollection RemoveDbContextOptionsRegistrations(
            this IServiceCollection services,
            Type dbContextType)
        {
