...
| **`IOrderExistenceChecker` contract deduplication** — defined in both Coupons and Fulfillment Contracts | —                                                                            | ✅ Done — merged to `Application/Sales/Shared/Contracts/`; single infra adapter; arch tests updated              |
