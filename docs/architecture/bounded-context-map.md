...
| ----------------------------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **Orders**                          | Behavioral aggregate      | Rich domain model → target                                                                                                                                                                                                                                                                                                                | ✅ New implementation ready (parallel) — Domain, Application, Infrastructure, Unit tests done; DB migration pending; atomic switch pending |
