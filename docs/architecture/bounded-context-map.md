...
| ----------------------------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **Orders**                          | Behavioral aggregate      | Rich domain model → target                                                                                                                                                                                                                                                                                                                | ✅ New implementation ready (parallel) — Domain, Application, Infrastructure, Unit tests, Integration tests done; DB migration ✅ approved; atomic switch pending |
...
| --- | ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Sales/Orders**                                            | [ADR-0014](../adr/0014-sales-orders-bc-design.md)                                                    | 🟡 In progress — Domain ✅, Application ✅, Infrastructure ✅, Unit tests ✅, Integration tests ✅ — DB migration ✅ approved; atomic switch pending (Steps 2–8)                 | — (legacy migration; Checkout Slice 2 + Payments depend on it)                                                                                        |
...
| 3   | **Sales/Payments**                                          | [ADR-0015](../adr/0015-sales-payments-bc-design.md)                                                  | 🟡 In progress — Domain ✅, Application ✅, Infrastructure ✅, Unit tests ✅, Integration tests ✅ — DB migrations ✅ approved; atomic switch pending                | Orders (#1); fixes `PaymentHandler → OrderService` sync call                                                                                          |
