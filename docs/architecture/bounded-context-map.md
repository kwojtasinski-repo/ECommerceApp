...
| **Payments**                        | Behavioral aggregate      | `Payment` state machine, own `IPaymentDbContext`, `PaymentHandler` → event-driven — see ADR-0015                                                                                                                                                                                                                                          | ✅ **Switch live** — all acceptance criteria met; legacy `PaymentHandler` retained for Step 5 cleanup |
...
| 2   | **Presale/Checkout — Slice 2** (cart + checkout write flow) | [ADR-0012](../adr/0012-presale-checkout-bc-design.md) §11–14 (formal amendment — not a separate ADR) | ✅ **Switch live** — all acceptance criteria met; integration tests ✅; EC-001 decision ✅                                                               | — (done)                                                                                                                                              |
| 3   | **Sales/Payments**                                          | [ADR-0015](../adr/0015-sales-payments-bc-design.md)                                                  | ✅ **Switch live** — all acceptance criteria met; Step 5/6 (cleanup) deferred                                                                                       | — (done)                                                                                                                                              |
| 4   | **Sales/Coupons**                                           | [ADR-0016](../adr/0016-sales-coupons-bc-design.md)                                                  | 📋 ADR proposed — Slice 1 not started                                                                                                   | **Atomic switch only** — blocked by Coupons Slice 1 in production                                                                                    |
| 5   | **Sales/Fulfillment**                                       | [ADR-0017](../adr/0017-sales-fulfillment-bc-design.md)                                               | 📋 ADR proposed — Slice 1 (Refund) can proceed                                                                                          | **Atomic switch only** — blocked by Fulfillment Slice 1 in production                                                                                |
...
| **Backoffice**               | [ADR-0020](../adr/0020-backoffice-bc-design.md) ✅               | Covered — application-only BC; no domain model. Scope and query assembly pattern defined. **Switch live** — all tiers complete. |
