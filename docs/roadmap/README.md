...
| **Context-mode — sandbox MCP (context reduction)** | [`context-mode-integration.md`](./context-mode-integration.md) + [`context-mode-details.md`](./context-mode-details.md) | — | 🔲 Planowanie — do implementacji po stabilizacji RAG MCP |
