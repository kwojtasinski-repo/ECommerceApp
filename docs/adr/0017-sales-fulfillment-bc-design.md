...
| 12–18 | Slice 2 — deferred features (`Shipment` aggregate + `ShipmentLine`, state machine, cross-BC handlers, `Order.MarkAsRefunded()`) — see §11 | 🔄 Implementation in progress — Domain ✅ Application ✅ Infrastructure ✅ (see §13 for design amendments) |
