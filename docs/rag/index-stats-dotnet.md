...
|------|----------|-------:|
| `.github/context/agent-decisions.md` | `context` | 26 |
| `.github/context/future-skills.md` | `context` | 6 |
| `.github/context/known-issues.md` | `context` | 16 |
...
| `docs/adr/0002/0002-post-event-storming-architectural-evolution-strategy.md` | `adr_main` | 17 |
...
| `docs/adr/0003/README.md` | `adr_router` | 4 |
...
| `docs/adr/0005/0005-accountprofile-bc-userprofile-aggregate-design.md` | `adr_main` | 11 |
...
| `docs/adr/0006/0006-typedid-and-value-objects-as-shared-domain-primitives.md` | `adr_main` | 12 |
| `docs/adr/0006/README.md` | `adr_router` | 4 |
...
| `docs/adr/0007/0007-catalog-bc-product-category-tag-aggregate-design.md` | `adr_main` | 18 |
...
| `docs/adr/0008/0008-supporting-currencies-bc-design.md` | `adr_main` | 11 |
...
| `docs/adr/0009/0009-supporting-timemanagement-bc-design.md` | `adr_main` | 22 |
| `docs/adr/0009/README.md` | `adr_router` | 5 |
...
| `docs/adr/0010/README.md` | `adr_router` | 5 |
...
| `docs/adr/0012/0012-presale-checkout-bc-design.md` | `adr_main` | 26 |
...
| `docs/adr/0012/migration-plan.md` | `adr_migration_plan` | 1 |
| `docs/adr/0013/0013-per-bc-dbcontext-interfaces.md` | `adr_main` | 14 |
...
| `docs/adr/0014/amendments/a3-integration-flow-decisions.md` | `adr_amendment` | 6 |
...
| `docs/adr/0014/migration-plan.md` | `adr_migration_plan` | 1 |
| `docs/adr/0015/0015-sales-payments-bc-design.md` | `adr_main` | 20 |
| `docs/adr/0015/README.md` | `adr_router` | 5 |
...
| `docs/adr/0016/migration-plan.md` | `adr_migration_plan` | 1 |
| `docs/adr/0017/0017-sales-fulfillment-bc-design.md` | `adr_main` | 28 |
...
| `docs/adr/0017/migration-plan.md` | `adr_migration_plan` | 1 |
| `docs/adr/0018/0018-supporting-communication-bc-design.md` | `adr_main` | 13 |
...
| `docs/adr/0023/0023-bootstrap-5-upgrade.md` | `adr_main` | 12 |
| `docs/adr/0023/README.md` | `adr_router` | 4 |
| `docs/adr/0023/checklist.md` | `adr_checklist` | 1 |
| `docs/adr/0023/example-implementation/bs5-component-migration.md` | `adr_example` | 1 |
| `docs/adr/0023/migration-plan.md` | `adr_migration_plan` | 1 |
...
| `docs/adr/0025/0025-api-tiered-access-trusted-purchase-policy.md` | `adr_main` | 9 |
...
| `docs/roadmap/bc-migration-history.md` | `roadmap` | 5 |
| `docs/roadmap/chunked-upload.md` | `roadmap` | 11 |
| `docs/roadmap/context-mode-details.md` | `roadmap` | 41 |
| `docs/roadmap/context-mode-integration.md` | `roadmap` | 31 |
