...
| `docs/adr/0001/migration-plan.md` | `adr_migration_plan` | 0 |
...
| `docs/adr/0002/README.md` | `adr_router` | 2 |
...
| `docs/adr/0003/example-implementation/bc-folder-structure-example.md` | `adr_example` | 0 |
...
| `docs/adr/0006/example-implementation/typedid-usage-examples.md` | `adr_example` | 0 |
| `docs/adr/0006/example-implementation/value-object-patterns.md` | `adr_example` | 0 |
...
| `docs/adr/0007/example-implementation/product-aggregate-usage.md` | `adr_example` | 0 |
...
| `docs/adr/0008/example-implementation/nbp-api-integration.md` | `adr_example` | 0 |
| `docs/adr/0008/migration-plan.md` | `adr_migration_plan` | 1 |
| `docs/adr/0008/README.md` | `adr_router` | 3 |
| `docs/adr/0009/0009-supporting-timemanagement-bc-design.md` | `adr_main` | 17 |
| `docs/adr/0009/amendments/a1-design-revisions.md` | `adr_amendment` | 6 |
| `docs/adr/0009/checklist.md` | `adr_checklist` | 1 |
| `docs/adr/0009/example-implementation/ideferred-job-scheduler-usage.md` | `adr_example` | 0 |
| `docs/adr/0009/example-implementation/ischeduledtask-implementation.md` | `adr_example` | 0 |
| `docs/adr/0009/example-implementation/job-registration-di.md` | `adr_example` | 0 |
...
| `docs/adr/0010/example-implementation/multi-handler-pattern.md` | `adr_example` | 0 |
| `docs/adr/0010/example-implementation/publish-message-example.md` | `adr_example` | 0 |
| `docs/adr/0010/example-implementation/register-handler-example.md` | `adr_example` | 0 |
| `docs/adr/0010/migration-plan.md` | `adr_migration_plan` | 1 |
| `docs/adr/0010/README.md` | `adr_router` | 5 |
| `docs/adr/0011/0011-inventory-availability-bc-design.md` | `adr_main` | 19 |
| `docs/adr/0011/amendments/a1-fulfillment-message-consumption.md` | `adr_amendment` | 3 |
| `docs/adr/0011/checklist.md` | `adr_checklist` | 1 |
| `docs/adr/0011/example-implementation/cross-bc-message-wiring.md` | `adr_example` | 0 |
| `docs/adr/0011/example-implementation/stock-adjustment-algorithm.md` | `adr_example` | 0 |
| `docs/adr/0011/example-implementation/two-phase-reservation-flow.md` | `adr_example` | 0 |
...
| `docs/adr/0012/example-implementation/checkout-confirm-flow.md` | `adr_example` | 0 |
| `docs/adr/0012/example-implementation/price-change-detection.md` | `adr_example` | 0 |
| `docs/adr/0012/example-implementation/soft-reservation-lifecycle.md` | `adr_example` | 0 |
| `docs/adr/0012/migration-plan.md` | `adr_migration_plan` | 1 |
| `docs/adr/0012/README.md` | `adr_router` | 4 |
| `docs/adr/0013/0013-per-bc-dbcontext-interfaces.md` | `adr_main` | 13 |
| `docs/adr/0013/checklist.md` | `adr_checklist` | 1 |
| `docs/adr/0013/example-implementation/dbcontext-interface-pattern.md` | `adr_example` | 0 |
...
| `docs/adr/0014/example-implementation/order-aggregate-usage.md` | `adr_example` | 0 |
| `docs/adr/0014/example-implementation/order-product-snapshot.md` | `adr_example` | 0 |
| `docs/adr/0014/example-implementation/place-order-flow.md` | `adr_example` | 0 |
| `docs/adr/0014/example-implementation/result-handling-pattern.md` | `adr_example` | 0 |
...
| `docs/adr/0015/example-implementation/order-cancel-flow.md` | `adr_example` | 0 |
| `docs/adr/0015/example-implementation/payment-state-machine.md` | `adr_example` | 0 |
| `docs/adr/0015/example-implementation/payment-window-expiry-flow.md` | `adr_example` | 0 |
| `docs/adr/0015/migration-plan.md` | `adr_migration_plan` | 1 |
| `docs/adr/0015/README.md` | `adr_router` | 5 |
| `docs/adr/0016/0016-sales-coupons-bc-design.md` | `adr_main` | 16 |
...
| `docs/adr/0016/example-implementation/apply-coupon-flow.md` | `adr_example` | 0 |
| `docs/adr/0016/example-implementation/coupon-evaluation-context.md` | `adr_example` | 0 |
| `docs/adr/0016/example-implementation/new-coupon-rule-guide.md` | `adr_example` | 0 |
| `docs/adr/0016/migration-plan.md` | `adr_migration_plan` | 1 |
| `docs/adr/0016/README.md` | `adr_router` | 5 |
| `docs/adr/0017/0017-sales-fulfillment-bc-design.md` | `adr_main` | 18 |
| `docs/adr/0017/amendments/a1-shipment-integration-and-fanout.md` | `adr_amendment` | 6 |
| `docs/adr/0017/checklist.md` | `adr_checklist` | 1 |
| `docs/adr/0017/example-implementation/refund-lifecycle-flow.md` | `adr_example` | 0 |
| `docs/adr/0017/example-implementation/shipment-dispatch-flow.md` | `adr_example` | 0 |
...
| `docs/adr/0021/example-implementation/fetch-first-pattern.md` | `adr_example` | 0 |
...
| `docs/adr/0022/example-implementation/navbar-razor-partial.md` | `adr_example` | 0 |
...
| `docs/adr/0023/example-implementation/bs5-component-migration.md` | `adr_example` | 0 |
...
| `docs/adr/0024/example-implementation/area-routing-examples.md` | `adr_example` | 0 |
