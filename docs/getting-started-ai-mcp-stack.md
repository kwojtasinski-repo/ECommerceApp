...
2. RAG (docs/ADR retrieval), and
3. the code-derived KG MCP server (structural graph retrieval)
...
## 3.1 Recommended default for teams
...
## 5. Token-control routing rule (important)
