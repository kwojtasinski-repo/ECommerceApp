...
> This file is the **AI routing layer**. Human-oriented docs start at `docs/README.md`.
> ADRs are folderized — open `docs/adr/<NNNN>/README.md` first, then follow that folder router.
