...
- ALWAYS ask clarifying questions before Step 3 when the requirements leave a business-impacting gap.
- ALWAYS include "To zależy / It depends" as an explicit option when a policy varies by situation.
